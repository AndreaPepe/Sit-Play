...
public class BusinessActivityDAO {
	...
	public static void insertActivity(String name, InputStream logo, String businessman) throws SQLException, DAOException {
	...
	public static List<BusinessActivity> retrieveActivitiesByOwner(String businessman) throws SQLException{
		...
		try {
			...
			while(rs.next()) {
				...
				var logo = imageBlob.getBinaryStream(0, imageBlob.length());
