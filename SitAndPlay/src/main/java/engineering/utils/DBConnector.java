 ...
 * 
 * It is used to guarantee a unique connection to a relational DBMS.
 * 
 * @author Andrea Pepe
 *
 */
public class DBConnector {
	...
	/**
	 * This method is "synchronized" to avoid the existence of multiple instances of
	 * DBConnector, due to concurrency.
	 */
	...
	/**
	 * The method getConnection() is "synchronized" to avoid the existence of
	 * multiple instances of connection, due to concurrency.
	 * 
	 * It loads JDBC driver with dynamic loading, reading configuration from a file.
	 */
		...
		if (this.conn == null) {
			try {
				...
				Logger.getLogger(this.getClass().getName()).log(Level.SEVERE,
						"[Class: DBConnector] Unable to load DB Driver dynamically. The file has not been found.");
			} catch (Exception e) {
